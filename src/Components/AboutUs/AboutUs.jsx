    ...
    return (
        <div id="about-us" className="lg:max-w-6xl 2xl:max-w-7xl mx-5 md:mx-8 lg:mx-8 xl:mx-auto my-10">
         ...
         <div className=" md:space-y-2 lg:space-y-4">
                ...
                <h2 className="text-base md:text-2xl lg:text-3xl text-[#1b1950] font-bold leading-9">We Help To Get <br></br> Soultions</h2>
                ...
                <button className="flex gap-3 items-center bg-yellow-400 px-4 py-2 rounded-xl font-semibold text-sm lg:text-base">Learn more <MdArrowOutward></MdArrowOutward></button>
            </div>
