...
import chart from "../../../src/assets/Group 12.png"
import book from "../../../src/assets/Icons.png"
...
import coin from "../../../src/assets/Group.png"

import video from "../../../src/assets/Group (1).png"
...
const Banner = () => {
    return (
        ...
        <div className="grid md:grid-cols-11 lg:grid-cols-11 gap-2 md:gap-3 lg:gap-5 lg:max-w-6xl 2xl:max-w-7xl mx-5 md:mx-8 lg:mx-8 xl:mx-auto">
           ...
           <div className="md:col-span-2 lg:col-span-2 bg-white shadow-xl p-3 lg:p-5 rounded-2xl flex gap-2 md:flex-col">
              <div>
              ...
              <p className="text-xs lg:text-sm text-[#575680]">Patient satisfaction rate, reflecting our commitment.</p>
               ...
               <img src={chart} className="w-16 md:w-20 lg:w-24 xl:w-28 mt-4 ml-2 lg:ml-7" alt="" />
           </div>
           ...
           <div className="md:col-span-7 lg:col-span-7">
            ...
            <div className="grid grid-cols-3 items-end gap-2 lg:gap-5">
                ...
                <div className="bg-yellow-50  shadow-lg rounded-2xl p-2 lg:p-6">
                    ...
                    <img src={book} className="w-11 lg:w-16 xl:w-20" alt="" />
                    </div>
                </div>
                <div>
                <div className=" rounded-2xl p-2 lg:p-6 shadow-lg space-y-2">
                    ...
                    <div className="flex ">
                    <img src={autho1} alt="author" className="w-6 lg:w-11" />
                    <img src={autho2} className="-ml-2 w-6 lg:w-11" alt="author" />
                    <img src={autho3} className="-ml-2 w-6 lg:w-11"  alt="author" />
                    <img src={autho4} className="-ml-2 w-6 lg:w-11" alt="author" />
                    </div>
                </div>
                </div>
                <div>
                <div className="bg-yellow-50 rounded-2xl p-2 lg:p-6">
                    ...
                    for poor patient</p>
                    <div className="flex justify-end">
                    <img src={coin} className="w-11 lg:w-16 xl:w-20"  alt="" />
                    </div>
                </div>
                </div>
            </div>
           ...
           <div className="md:col-span-2 lg:col-span-2 bg-white shadow-xl p-3 lg:p-5 rounded-2xl flex gap-2 md:flex-col">
              ...
              <h2 className="text-base md:text-xl lg:text-3xl text-[#272568] font-bold">50+</h2>
               ...
               <img src= {video} className="w-16 md:w-20 lg:w-24 xl:w-28 mt-8 ml-2 lg:ml-7 lg:mt-12" alt="" />
           </div>
